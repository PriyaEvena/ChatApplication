...
public class ChatBotActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (metadata != null) {
                        ...
                        if(metadata.getIntentId().equals("84e47689-235a-4bd8-ba8e-d0203aeead6f")){
                            Log.i(TAG, "THIS IS NAME "+metadata.getIntentId());
